...
public class ShardingJdbcUtils {
    ...
    /** [构造] */
    protected ShardingJdbcUtils(@Value("${sharding.createTable.byDate.dsUrl:#{null}}") String dsUrl,
                                @Value("${sharding.createTable.byDate.dsUsername:#{null}}") String dsUsername,
                                @Value("${sharding.createTable.byDate.dsPassword:#{null}}") String dsPassword) {
        setDsUrl(dsUrl);
        setDsUsername(dsUsername);
        setDsPassword(dsPassword);
    }
