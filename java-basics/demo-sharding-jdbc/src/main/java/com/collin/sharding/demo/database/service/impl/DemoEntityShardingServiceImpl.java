package com.collin.sharding.demo.database.service.impl;

import com.collin.sharding.demo.database.db.entity.DemoEntitySharding;
import com.collin.sharding.demo.database.db.repository.DemoEntityShardingRepository;
import com.collin.sharding.demo.database.pojo.query.DemoEntityShardingQueryDto;
import com.collin.sharding.demo.database.pojo.upsert.DemoEntityShardingUpsertDto;
import com.collin.sharding.demo.database.service.DemoEntityShardingService;
...
public class DemoEntityShardingServiceImpl implements DemoEntityShardingService {
    ...
    public Page<DemoEntitySharding> getPage(DemoEntityShardingQueryDto dto) {
        return demoEntityShardingRepository.findAllByIsDeletedIsFalse(PageRequest.of(dto.getPage() - 1, dto.getSize()));
    }
