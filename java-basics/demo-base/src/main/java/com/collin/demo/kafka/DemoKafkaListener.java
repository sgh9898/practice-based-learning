package com.collin.demo.kafka;

import com.collin.demo.database.db.entity.DemoEntity;
import com.collin.demo.util.JsonUtils;
...
public class DemoKafkaListener {
     ...
     */
    @KafkaListener(id = "demoBatchListener", groupId = "demoKafkaGroup", topics = "demoRegion", errorHandler = "batchKafkaListenerErrorHandler")
     ...
     * @param acknowledgment 发送消息确认
     */
    @KafkaListener(id = "demoSingleListener", groupId = "demoKafkaGroup", topics = "demoRegion", errorHandler = "singleKafkaListenerErrorHandler")
