...
import com.demo.easyexcel.util.EasyExcelUtilsProtected;
...
public class ExcelServiceImpl implements ExcelService {
    ...
    public void downloadTemplate(HttpServletRequest request, HttpServletResponse response) {
        ...
        EasyExcelUtils.exportTemplate(request, response, "Excel-to-Sql-template.xlsx", ExcelToSql.class, note);
    }
    ...
    public void exportData(HttpServletRequest request, HttpServletResponse response) {
        List<DemoExcelEntity> list = demoExcelEntityRepository.findAllByIsDeletedIsFalse();
        System.out.println(JsonUtil.beanOrListToJsonStr(list));
        EasyExcelUtils.exportData(request, response, "测试", DemoExcelEntity.class, list);
    }
    ...
    public void exportDataNoModel(HttpServletRequest request, HttpServletResponse response) {
        ...
        EasyExcelUtilsProtected.exportExcelNoModel(request, response, "导出数据", null, headList, entityList, false, null, null, null, null);
    }
