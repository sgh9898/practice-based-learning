...
// ------------------------------ Public, 导入 ------------------------------
     ...
     * @param listener    ExcelListener, 允许 extends {@link ZippedListener}
     ...
     */
    public static <T, U extends ZippedListener<T>> Boolean baseImportExcel(MultipartFile file, HttpServletRequest request, HttpServletResponse response,
     ...
     * @return true = 成功, false = 文件为空, null = 失败且下载含报错信息的 Excel 文件
     */
    public static <T extends ZippedListenerNoModel> Boolean noModelBaseImportExcel(MultipartFile file, HttpServletRequest request, HttpServletResponse response,
...
// ------------------------------ Public, 导出 ------------------------------
    ...
    public static void baseWriteSheet(ExcelWriter excelWriter, Class<?> excelClass, Integer sheetIndex, String sheetName, List<?> dataList,
                                      ...
                                      Map<String, String> replaceHeadMap, ZippedEnumsColWidth widthStrategy) {
        // 防报错
        ...
        // 自适应行高
        sheetBuilder.registerWriteHandler(new ZippedHandlerRowHeight());
    ...
    public static void noModelBaseWriteSheet(ExcelWriter excelWriter, Integer sheetIndex, String sheetName, List<List<String>> cnHeadList, Set<String> specialHeadSet, List<List<Object>> dataList,
                                             String title, String note, Map<Integer, String[]> dropDownMap, ZippedEnumsColWidth widthStrategy) {
        // 计数, 未被排除的列
        ...
        // 自适应列宽
        sheetBuilder.registerWriteHandler(new ZippedHandlerColumnWidth(widthStrategy));
        // 自适应行高
        sheetBuilder.registerWriteHandler(new ZippedHandlerRowHeight());
