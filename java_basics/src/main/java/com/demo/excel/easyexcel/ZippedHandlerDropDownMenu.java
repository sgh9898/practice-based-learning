 ...
 */
class ZippedHandlerDropDownMenu implements SheetWriteHandler {
    ...
    /** 构造: 默认 */
    public ZippedHandlerDropDownMenu(Map<Integer, String[]> dropDownMap) {
    ...
    public ZippedHandlerDropDownMenu(Map<Integer, String[]> dropDownMap, Integer skipRowNum) {
        this.dropDownMap = dropDownMap;
        // head 不配置下拉框
