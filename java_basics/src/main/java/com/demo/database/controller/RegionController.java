...
public class RegionController {
    ...
    public ApiResp upsert(@RequestBody RegionUpsertDto dto) {
        regionService.upsert(dto);
    ...
    @PostMapping("/delete")
    @ApiOperation("[删除] 区号")
    public ApiResp delete(@RequestBody RegionUpsertDto dto) {
        regionService.delete(dto.getIdList());
        return ApiResp.success();
    }
    ...
    @GetMapping("/get")
    @ApiOperation("[查询] 区号")
    public ApiResp.Entity<Region> get(@RequestBody RegionUpsertDto dto) {
        return new ApiResp.Entity<>(regionService.get(dto.getId()));
    }

    /** [列表] 区号 */
    @GetMapping("/getList")
    @ApiOperation("[列表查询] 区号")
    public ApiResp.ListEntity<Region> getList(@RequestBody RegionUpsertDto dto) {
        return new ApiResp.ListEntity<>(regionService.getList());
    }

    /** [分页] 区号 */
    @GetMapping("/getPage")
    @ApiOperation("[分页查询] 区号")
    public ApiResp.PageEntity<Region> getPage(@RequestBody RegionQueryDto dto) {
        return new ApiResp.PageEntity<>(regionService.getPage(dto));
    }
    ...
    public void importData(MultipartFile file, HttpServletRequest request, HttpServletResponse response) {
        ...
        regionService.importData(file, request, response);
    }
    ...
    public void exportTemplate(HttpServletRequest request, HttpServletResponse response) {
        regionService.exportExcelTemplate(request, response);
    }
    ...
    public void exportData(HttpServletRequest request, HttpServletResponse response) {
        regionService.exportData(request, response);
    }
}
