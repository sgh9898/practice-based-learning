...
@Getter
@Setter
@Table(name = "demo_entity_sharding_extra_copy")
@Schema(description = "[实体类] 测试数据--分库分表")
@JsonIgnoreProperties(ignoreUnknown = true)
public class DemoEntityShardingExtraCopy {
    ...
    /** [构造] */
    public DemoEntityShardingExtraCopy() {
        init();
    }

    /** [构造] 根据 dto 创建 */
    public DemoEntityShardingExtraCopy(DemoEntityShardingExtraCopyUpsertDto dto) {
        init();
        update(dto);
    }
    ...
    /** 根据 dto 更新 */
    public void update(DemoEntityShardingExtraCopyUpsertDto dto) {
