package com.sgh.demo.sharding.sharding.algorithm.table;
...
public class TimeShardingAlgorithm implements StandardShardingAlgorithm<Date> {
    ...
    public Collection<String> doSharding(Collection<String> availableTargetNames, RangeShardingValue<Date> rangeShardingValue) {
        ...
        String minTableName = logicTableName + TABLE_SHARDING_SEPARATOR + ShardingDateUtils.toStr(startDate, TABLE_SHARDING_PATTERN);
        String maxTableName = logicTableName + TABLE_SHARDING_SEPARATOR + ShardingDateUtils.toStr(endDate, TABLE_SHARDING_PATTERN);
